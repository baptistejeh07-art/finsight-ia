...
def _slide_07_secteurs(prs, d: dict):
    ...
    if sector_cmp:
        try:
            ...
            ax.invert_yaxis()
            ax.set_xlabel("Poids (%)", fontsize=11, labelpad=8)
...
def _slide_10_perf_chart(prs, d: dict):
    ...
    if has_data:
        try:
            ...
            ax.set_ylabel("Base 100", fontsize=11, labelpad=8)
...
def _slide_11_perf_decomposition(prs, d: dict):
    ...
    try:
        ...
        ax.set_ylabel("Performance (%)", fontsize=11, labelpad=8)
...
def _slide_13_risk_return(prs, d: dict):
    ...
    try:
        ...
        ax.set_xlabel("Volatilité annualisée (%)", fontsize=12, labelpad=8)
        ax.set_ylabel("Performance 1 an (%)", fontsize=12, labelpad=8)
